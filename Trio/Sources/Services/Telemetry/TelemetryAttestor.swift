...
final class TelemetryAttestor: Injectable {
    ...
    func registerIfNeeded(baseURL: URL, reason: String, lastFailureReason: String?) async throws {
        injectIfNeeded()
    ...
    private func fetchChallenge(baseURL: URL, reason: String, lastFailureReason: String?) async throws -> String {
